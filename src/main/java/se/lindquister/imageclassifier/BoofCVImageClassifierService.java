...
@Service
public class BoofCVImageClassifierService implements ImageClassifierService {
	...
	@Override
	public ImageClassification classify(String url) throws MalformedURLException {
